 ...
 * Simply converts values to JSON and retreives them, too.
 * The local implementation of JSON object is thanks to
...
(function($) {
  ...
  (function() {
      ...
      switch (typeof value) {
        ...
        case 'object':
          ...
          if (Object.prototype.toString.apply(value) === '[object Array]') {
            ...
            // The value is an array. Stringify every element. Use null as
            // a placeholder for non-JSON values.
    ...
    if (typeof JSON.stringify !== 'function') {
      JSON.stringify = function(value, replacer, space) {
        ...
        // will select the keys. A default replacer method can be provided.
        // Use of the space parameter can produce text that is more easily
        // readable.
    ...
    if (typeof JSON.parse !== 'function') {
      JSON.parse = function(text, reviver) {
        ...
        // that look for non-JSON patterns. We are especially concerned with
        // '()' and 'new' because they can cause invocation, and '=' because
        // it can cause mutation. But just to be safe, we want to reject all
        // unexpected forms.
        ...
        // characters. Third, we delete all open brackets that follow a colon
        // or comma or that begin the text. Finally, we look to see that the
        ...
        .test(text.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, '@')
          ...
          // structure, passing each name/value pair to a reviver function
  ...
  // Add to the window, just in case.
  window.JSON = JSON;

  // Done with JSON support checking, on to the plugin.
